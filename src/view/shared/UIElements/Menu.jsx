...
const Menu = () => {
    ...
    return (
        <div className="fixed top-4 w-full inset-0 z-50">
    ...
    <div className='flex justify-between items-center w-full fixed px-4 py-3 z-50'>
    ...
    <div ref={menuRef} className={`fixed top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden ${isMenuOpen ? 'opacity-100 scale-y-100 z-50' : 'opacity-0 scale-y-0 z-50'}`}>
        <div className="rounded-lg bg-white shadow-md ring-1 ring-black ring-opacity-5 z-50">
        {
                    MenuTitles.map((data, index) => (
                        <ScrollLink
                            to={data.link}
