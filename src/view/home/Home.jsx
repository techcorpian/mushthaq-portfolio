...
const Home = () => {
    return (
        <main>
            ...
            <Journey />
            <TechStacks />
            <Project projectTitle="School Management System" projectTag="Project 01" Image1={sms4} Image2={sms5} Image3={sms1} Image4={sms3} bgColor="bg-black/30" stickyH="top-[40px] md:top-[80px]">
                ...
                <div className='font-bold'>Technical View</div>
                <div className='font-thin'>The frontend is built using React JS, featuring a unique architecture. It communicates with the backend through API requests made with Axios. The backend, developed with Node JS (Express JS), retrieves data from a MySQL database and provides it as a response to the API calls from the frontend.</div><br />

                <div className='font-thin'>Authentication is managed using JWT tokens to ensure enhanced security, while authorization is handled through user groups and permissions, ensuring appropriate access control.</div><br />
            ...
            <Project projectTitle="Ethereum Staking Application" projectTag="Project 02" Image1={gld1} Image2={gld2} Image3={gld4} Image4={gld5} bgColor="bg-gray-900" stickyH="top-[100px] md:top-[160px]">
                ...
                <div className='font-bold'>Technical View </div>
                <div className='font-thin'>Used the MetaMask extension in the browser to manage a dummy wallet locally.
                ...
                <div className='font-thin'>Authentication is seamlessly managed using the Thirdweb library to log into their wallets.</div><br />

                <div className='font-thin'>Chart.js provides analytical insights by visually displaying transaction data in a chart format.</div><br />
            ...
            <Project projectTitle="Secured Authentication System" projectTag="Project 03" Image1={cms1} Image2={cms3} Image3={cms6} Image4={cms5} bgColor="bg-gray-800" stickyH="top-[160px] md:top-[240px]">
                ...
                <div className='font-bold'>Technical View</div>
                <div className='font-thin'>The application employs a unique architecture in React to enhance code quality while minimising code redundancy.</div><br/>
                <div className='font-thin'>On the backend, it integrates the Sanctum library within the API routing system, ensuring that no HTTP methods can be executed without proper authentication.</div><br/>
